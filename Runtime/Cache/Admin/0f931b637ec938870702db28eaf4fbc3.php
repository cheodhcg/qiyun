...
<script>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
		<div class="form-item">
            <label class="item-label">讲座类型</label>
            <div class="controls">
                <input type="text" class="text input-large" name="repassword" value="<?php echo ($info['type_txt']); ?>" readonly>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">讲座标题<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="username" value="<?php echo ($info['title']); ?>" readonly>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">讲座封面<span class="check-tips"></span></label>
            <div class="controls">
                <img src="<?php echo ($info['icon']); ?>" width="300px;"height="200px;"/>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">讲座内容</label>
            <div class="controls">
                <textarea rows="5" cols="100"><?php echo ($info['content']); ?></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">讲座金额<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="email" value="<?php echo ($info['money']); ?>" readonly>
            </div>
        </div>
		<div class="form-item">
            <label class="item-label">试听次数<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="email" value="<?php echo ($info['number']); ?>" readonly>
            </div>
        </div>
		<div class="form-item">
            <label class="item-label">发布人/发布时间<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="email" value="<?php echo ($info['username']); ?> / <?php echo (date('Y-m-d H:i',$info['addtime'])); ?>" readonly>
            </div>
        </div>
		<div class="form-item">
            <label class="item-label">是否推荐<span class="check-tips"></span></label>
            <div class="controls">
                <input type="radio" class="text" name="is_tj" style="width:20px;" value="0" <?php if($info['number'] == 0): ?>checked<?php endif; ?>>否
				<input type="radio" class="text" name="is_tj" style="width:20px;" value="1" <?php if($info['number'] == 1): ?>checked<?php endif; ?>>是
            </div>
        </div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Lecture/index');?>');
    </script>
