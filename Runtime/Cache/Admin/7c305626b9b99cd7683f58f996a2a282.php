...
<body>
	...
	<div class="cf">
		<div class="fl">
		            ...
		            <button class="btn ajax-post confirm" url="<?php echo U('changeStatus');?>" target-form="ids">删 除</button>
		</div>

        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入提问标题和提问人">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo substr($vo['content'],0,100)?></td>
			<td><?php if(($vo['uid']) == ""): ?>用户发布<?php else: ?>系统发布<?php endif; ?>--<?php echo (date('Y-m-d H:i',$vo["addtime"])); ?></td>
			<td><?php if(($vo['is_tj']) == "1"): ?>是<?php else: ?>否<?php endif; ?></td>
			<td><a href="<?php echo U('info?id='.$vo['id']);?>">详情</a></td>
