...
<body>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('info?id='.$vo['id']);?>">详情</a>
				<?php if(($vo['is_tj']) == "0"): ?><a href="<?php echo U('setTj?id='.$vo['id'].'&status=1');?>" class="ajax-get">推荐</a>
					<?php else: ?>
					<a href="<?php echo U('setTj?id='.$vo['id'].'&status=0');?>" class="ajax-get">取消推荐</a><?php endif; ?>
