    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <?php if(($info['cover_id']) == ""): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info['cover_id'],'path')); ?>"/></div><?php endif; ?>
                </div>
            </div>
		...
		<div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="number" value="<?php echo ($info['number']); ?>">
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="level">
                    <?php if(is_array($level)): $i = 0; $__LIST__ = $level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><option value="<?php echo ($l["id"]); ?>" <?php if(($i) == "1"): ?>selected<?php endif; ?> ><?php echo ($l["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="form-item cf">
            ...
            <label class="textarea input-large" style="width:100%;">
                ...
                <link rel="stylesheet" href="/qiyun/Public/static/kindeditor/default/default.css" />
                <script charset="utf-8" src="/qiyun/Public/static/kindeditor/kindeditor-min.js"></script>
                <script charset="utf-8" src="/qiyun/Public/static/kindeditor/zh_CN.js"></script>
                <script type="text/javascript">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="radio" class="text" name="is_tj" value="0" style="width:60px;" <?php if($info['is_tj'] == 0): ?>checked<?php endif; ?>>否
                <input type="radio" class="text" name="is_tj" value="1" style="width:60px;" <?php if($info['is_tj'] == 1): ?>checked<?php endif; ?>>是
            </div>
        </div>
        <div class="form-item">
