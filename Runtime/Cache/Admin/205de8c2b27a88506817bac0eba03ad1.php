...
<script>
    ...
    <tbody>
        <?php if(!empty($$info['list'])): if(is_array($$info['list'])): $i = 0; $__LIST__ = $$info['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Question/index');?>');
    </script>
