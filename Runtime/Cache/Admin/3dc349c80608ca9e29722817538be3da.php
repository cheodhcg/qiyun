...
<body>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo U('addWare');?>">新 增</a>
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('Shop/changeStatus?method=forbidUser2&id='.$vo['id']);?>" class="ajax-get">禁用</a>
                            <?php else: ?>
                            <a href="<?php echo U('Shop/changeStatus?method=resumeUser2&id='.$vo['id']);?>" class="ajax-get">启用</a><?php endif; ?>
                            <a href="<?php echo U('Shop/changeStatus?method=deleteUser2&id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                            <a href="<?php echo U('Shop/addWare?id='.$vo['id']);?>">详情</a>
                        </td>
