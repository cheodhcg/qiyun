...
<div class="my_vip container oh" style="height: 100%">
    ...
    <div>
        ...
        <a href="##" <?php if(($level) == "2"): ?>class="vip_btn2" <?php else: ?> class="vip_btn"<?php endif; ?>>成为VIP会员</a>
        <a href="<?php echo U('User/invitation');?>" <?php if(($level) == "0"): ?>class="vip_btn2" <?php else: ?> class="vip_btn"<?php endif; ?>>输入邀请码</a>
