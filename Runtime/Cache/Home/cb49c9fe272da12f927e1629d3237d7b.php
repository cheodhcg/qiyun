...
<div class="my_vip container oh" style="height: 100%">
    ...
    <div>
        <a href="##" <?php if(($level) == "1"): ?>class="vip_btn2" <?php else: ?> class="vip_btn"<?php endif; ?>>成为会员（99/年）</a>
        <a href="##" <?php if(($level) == "2"): ?>class="vip_btn2" <?php else: ?> class="vip_btn"<?php endif; ?>>成为VIP会员（299/年）</a>
