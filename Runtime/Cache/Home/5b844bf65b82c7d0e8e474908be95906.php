...
<div class="wt_info ">
    <div class="question_info container  oh underline">
        ...
        <?php if($info['userinfo']['face']): ?><p>
            ...
            <span class="q_text2 fr"><?php echo ($info['userinfo']['company']); ?> | <?php echo ($info['userinfo']['position']); ?></span></p><?php endif; ?>
    </div>
    <div class="q_a container oh">
        <div class="q_a_title oh">
            <a href="<?php echo U('Index/question_release');?>"><span><img src="images/wt_03.png" alt="aa" width="100%" align="absmiddle"></span>我要提问</a>
            <?php if($flag): ?><a href="<?php echo U('Index/answer',array('id'=>$info['id']));?>"
            style="pointer-events:none; color:#ccc; cursor:default "><span><img src="images/h_03.png" alt=" aa" width="100%" align="absmiddle"></span>我已回答</a>
            <?php else: ?>
            <a href="<?php echo U('Index/answer',array('id'=>$info['id']));?>"><span><img src="images/h_03.png" alt=" aa" width="100%" align="absmiddle"></span>我要回答</a><?php endif; ?>
            ...
            <div style="min-height: 48px">
                ...
                <div class="weixinAudio fl">
                    ...
                    <span id="audio_area" class="db audio_area">
                                <span class="audio_wrp db" data-id="<?php echo ($info['questionlist'][0][id]); ?>" onclick="playRecord(this)">
    ...
    <div class="xg_question oh ">
        <div class="xg_title underline oh container ">
            <a href=""><span><img src="images/wt_06.png" alt=" aa" width="100%" align="absmiddle"></span>相关问题</a>
        </div>
            ...
            <?php if(is_array($xglist)): $i = 0; $__LIST__ = $xglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/questioninfo?id='.$x['pid']);?>">
                <div class="wd_c_box underline oh ">
                    ...
                    <?php if($x['questionlist']): ?><div style="">
                        <div class="wd_img_t fl"><img src="<?php echo ($x["questionlist"]["face"]); ?>" alt="aa" width="48" style="border-radius: 24px"></div>
                        <div class="wd_img_y fl"><img src="images/w_10.png" alt="aa" width="100%" align="bottom"><span><?php echo ($x['questionlist']['money']); ?></span></div>
