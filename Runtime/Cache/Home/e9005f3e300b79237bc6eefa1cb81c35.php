...
<div class="sc-nav">
    <ul>
        <li><a href="1#"><img src="images/sc01.png" alt="i" width="80%"> <br>房产</a></li>
        <li><a href="2#"><img src="images/sc02.png" alt="i" width="80%"> <br>房产</a></li>
        <li><a href="3#"><img src="images/sc03.png" alt="i" width="80%"> <br>房产</a></li>
        <li><a href="4#"><img src="images/sc04.png" alt="i" width="80%"> <br>房产</a></li>
        <li><a href="5#"><img src="images/sc05.png" alt="i" width="80%"> <br>房产</a></li>
    </ul>
</div>
<div class="sc_list  oh" id="listdiv">
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="sc_list_info fl oh">
            <a href="<?php echo U('info?id='.$vo['id']);?>">
                <img src="/qiyun<?php echo ($vo["path"]); ?>" alt="aa" width="141" height="95">
