...
<div class="wt_info ">
    ...
    <div class="q_a container oh">
        ...
        <div class="q_a_info1">
            <?php if($is_answer): ?><div class="yy_btn" style="width: 200px;text-align: center"><span style="  width:100%">您已回答过该问题</span></div>
                <?php else: ?>
                ...
                <?php if(is_array($xglist)): $i = 0; $__LIST__ = $xglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?><div class="wd_c_box underline oh ">
                        ...
                        <div style="">
                            ...
                            <div class="weixinAudio fl">
                                ...
                                <span class="audio_wrp db" data-id="<?php echo ($x["id"]); ?>" onclick="playRecord(this)">
